<script>
	...
	import { signupdone } from './store.js';
	...
	const handleSubmit = async () => {
		...
		let response = await fetch('http://127.0.0.1:8000/auth/api/users/', data)
		if (response.ok) {
			success = true;
		}
...
<h1 class="text-6xl font-black w-full text-center opacity-100">SignUp Here!</h1>
<form
